...
import { GoogleOAuthProvider } from "@react-oauth/google"; // <-- YE ADD KIYA
...
const PageLoader = () => (
  <div className="min-h- flex items-center justify-center bg-[#EAEDED]">
    <div className="flex flex-col items-center gap-3">
      <div className="w-12 h-12 border-4 border-[#FFD814] border-t-transparent rounded-full animate-spin" />
      <span className="text- text-[#565959] font-medium">Loading ShopZone - Amazon style...</span>
    </div>
  </div>
);
...
function App() {
  ...
  return (
    <GoogleOAuthProvider clientId="791675486099-4c4ag08kjp4u10ei01imbldt2tg97vi2.apps.googleusercontent.com">
      <BrowserRouter>
          ...
          <main className="flex-1">
            ...
            <Suspense fallback={<PageLoader />}>
              <Routes>
                ...
                <Route path="*" element={
                  <div className="bg-white min-h- grid place-items-center p-10">
                    <div className="text-center max-w-">
                      <div className="text- mt-4">Dog</div>
                      <h1 className="text- font-bold mt-4 text-[#0F1111]">Looking for something?</h1>
                      <p className="text- text-[#565959] mt-2">We are sorry. The Web address you entered is not a functioning page on ShopZone.</p>
                      <div className="flex gap-2 justify-center mt-6 flex-wrap">
                        <a href="/" className="h-9 px-6 bg-[#FFD814] hover:bg-[#F7CA00] border border-[#FCD200] rounded-lg text- font-bold grid place-items-center shadow-sm">Go to Homepage</a>
                        <a href="/products" className="h-9 px-6 bg-white border border-[#d5d9d9] rounded-lg text- grid place-items-center shadow-sm">Browse Products</a>
                      </div>
                    </div>
                  </div>
                } />
