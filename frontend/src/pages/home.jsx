...
function Home() {
  const categories = [
    { name: "Smartphones", icon: "📱", text: "Latest smartphones" },
    { name: "Laptops", icon: "💻", text: "Powerful laptops" },
    { name: "Smart Watches", icon: "⌚", text: "Wearable technology" },
    { name: "Audio", icon: "🎧", text: "Premium sound" },
  ];
    ...
    <main className="home">
      ...
      <section className="home-hero">
        <div className="home-container home-hero-grid">
          ...
          <div className="home-hero-content">
            ...
            <p>
              Premium electronics, smart accessories and
              everyday essentials from trusted vendors.
            </p>
      ...
      <section className="home-section">
        <div className="home-container">
          ...
          <div className="home-section-heading">
            <div>
              <span className="home-label">EXPLORE</span>
      ...
      <section className="home-section home-products-section">
        <div className="home-container">
          ...
          <div className="home-section-heading">
            <div>
              <span className="home-label">TRENDING NOW</span>
      ...
      <section className="home-section">
        <div className="home-container">
          ...
          <div className="home-section-heading">
            <div>
              <span className="home-label">BEST SELLERS</span>
      ...
      <section className="home-reviews">
        <div className="home-container">
          ...
          <div className="home-section-heading centered">
            <div>
              <span className="home-label">CUSTOMER REVIEWS</span>
          ...
          <div className="home-review-grid">
            ...
            <article className="home-review-card">
              ...
              <p>
                ...
                The shopping experience was excellent."
              </p>
            ...
            <article className="home-review-card">
              <div className="home-review-stars">★★★★★</div>
              <p>
                "Easy ordering, good prices and excellent
                customer support."
              </p>
      ...
      <section className="home-newsletter">
        <div className="home-container home-newsletter-inner">
          ...
          <div>
            <span className="home-label">STAY UPDATED</span>
